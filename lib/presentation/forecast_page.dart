...
import 'containers/forecast_air_pollution_container.dart';
...
import 'forecast_air_pollution_column.dart';
import 'forecast_weather_column.dart';
import 'extensions.dart';
import 'forecast_pollution_row.dart';
        ...
        builder: (BuildContext context, CurrentWeather? weatherData) {
          ...
          return ForecastWeatherContainer(
            builder: (BuildContext context, ForecastWeather? forecastWeatherData) {
              ...
              return ForecastAirPollutionContainer(
                  builder: (BuildContext context, AirPollutionDataForecast? forecastAirPollution) {
                if (forecastAirPollution == null) {
                  return const Center(
                    child: CircularProgressIndicator(),
                  );
                }
                                            ...
                                            children: <Widget>[
                                                    ...
                                                    children: <Widget>[
                                                      const Column(
                                                        children: <Widget>[
                                                          ...
                                                          Text('AQI', style: TextStyle(fontSize: 17)),
                                                          Text('PM2.5', style: TextStyle(fontSize: 17)),
                                                          Text('PM10', style: TextStyle(fontSize: 17)),
                                                        ],
                                                      ),
                                                      for (int i = 0; i < 6; i++)
                                                        ForecastAirPollutionColumn(
                                                          forecastAirPollutionData: forecastAirPollution,
                                                          index: i,
                                                        ),
                                                    ],
                                                  ),
                                                    ...
                                                    children: <Widget>[
                                                      ...
                                                      Row(
                                                        ...
                                                        children: <Widget>[
                                                          ...
                                                          PollutantColumn(
                                                              name: 'O3',
                                                              value: airPollutionData.list[0].components.o3),
                                                          PollutantColumn(
                                                              name: 'CO',
                                                              value: airPollutionData.list[0].components.co),
                                                        ],
                                                      ),
                                                    ],
                                                  ),
                                              ...
                                              Card(
                                                ...
                                                child: Padding(
                                                  ...
                                                  child: Column(
                                                    children: <Widget>[
                                                      ForecastAirPollutionRow(
                                                          airPollutionDataForecast: forecastAirPollution, hours: 0),
                                                      const SizedBox(height: 10),
                                                      ForecastAirPollutionRow(
                                                          airPollutionDataForecast: forecastAirPollution, hours: 24),
                                                      const SizedBox(height: 10),
                                                      ForecastAirPollutionRow(
                                                          airPollutionDataForecast: forecastAirPollution, hours: 48),
                                                      const SizedBox(height: 10),
                                                      ForecastAirPollutionRow(
                                                          airPollutionDataForecast: forecastAirPollution, hours: 72),
                                                    ],
                                                  ),
                                                ),
                                              ),
